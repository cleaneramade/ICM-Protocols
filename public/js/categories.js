...
// Exported: the server imports this module too (it is dependency-free), so
// rule→category resolution is identical on both sides of the API.
export const RULE_ID_TO_CAT = (() => {
  const m = {};
